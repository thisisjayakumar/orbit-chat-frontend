          ...
          .map(orgUser => {
            ...
            conversations.forEach(conv => {
              if (conv.participants) {
                const participant = conv.participants.find(p => p.user_id === orgUser.id);
                if (participant) {
            ...
            return {
              id: orgUser.id,
              display_name: orgUser.display_name || 'Unknown User',
              email: orgUser.email,
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4 space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors text-sm font-medium"
          >
